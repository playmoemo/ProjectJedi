    ...
    public sealed partial class StudentsPage : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (e.PageState == null)
            {
                ...
                if (!this.UsingLogicalPageNavigation() && this.studentsViewSource.View != null)
                {
                    this.studentsViewSource.View.MoveCurrentToFirst();
                }
            }
            else
            {
                // Restore the previously saved state associated with this page
                if (e.PageState.ContainsKey("SelectedItem") && this.studentsViewSource.View != null)
                {
        ...
        {
            if (this.studentsViewSource.View != null)
            {
