    ...
    public sealed partial class TimeSheetsPage : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (e.PageState == null)
            {
                ...
                if (!this.UsingLogicalPageNavigation() && this.timeSheetsViewSource.View != null)
                {
                    this.timeSheetsViewSource.View.MoveCurrentToFirst();
                }
            }
            else
            {
                // Restore the previously saved state associated with this page
                if (e.PageState.ContainsKey("SelectedItem") && this.timeSheetsViewSource.View != null)
                {
        ...
        {
            if (this.timeSheetsViewSource.View != null)
            {
